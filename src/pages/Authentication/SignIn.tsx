...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://coral-app-fvdip.ondigitalocean.app/api/login', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('authToken', data.user.token); // Store token for authentication
        setSuccessMessage('Logged in successfully!');
        // Redirect to another page (example: dashboard)
        setTimeout(() => {
          window.location.href = '/';
        }, 2000); // Redirect after 2 seconds for a smooth experience
      } else {
        // Handle login error
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">Online Booking</p>
